...
public static class PhotonNetwork
{
    ...
    public static bool CloseConnection(PhotonPlayer kickPlayer)
    {
        ...
        options2.TargetActors = new int[] { kickPlayer.ID };
    ...
    public static void Disconnect()
    {
        if (offlineMode)
        {
            ...
            networkingPeer.State = global::PeerState.Disconnecting;
    ...
    public static GameObject InstantiateSceneObject(string prefabName, Vector3 position, Quaternion rotation, int group, object[] data)
    {
        ...
        if (!connected || (InstantiateInRoomOnly && !inRoom))
        {
            Debug.LogError(string.Concat(new object[] { "Failed to InstantiateSceneObject prefab: ", prefabName, ". Client should be in a room. Current connectionStateDetailed: ", connectionStateDetailed }));
            return null;
        }
        if (!isMasterClient)
        {
    ...
    {
        if (((connectionStateDetailed == global::PeerState.Joining) || (connectionStateDetailed == global::PeerState.Joined)) || (connectionStateDetailed == global::PeerState.ConnectedToGameserver))
        {
    ...
    public static bool connected
    {
        get
        {
            ...
            return (((!networkingPeer.IsInitialConnect && (networkingPeer.State != global::PeerState.PeerCreated)) && ((networkingPeer.State != global::PeerState.Disconnected) && (networkingPeer.State != global::PeerState.Disconnecting))) && (networkingPeer.State != global::PeerState.ConnectingToNameServer));
        }
    }
    ...
    public static bool connectedAndReady
    {
        get
        {
            ...
            if (!offlineMode)
            {
                ...
                {
                    case global::PeerState.ConnectingToGameserver:
                    case global::PeerState.Joining:
                    case global::PeerState.Leaving:
                    case global::PeerState.ConnectingToMasterserver:
                    case global::PeerState.Disconnecting:
                    case global::PeerState.Disconnected:
                    case global::PeerState.ConnectingToNameServer:
                    case global::PeerState.Authenticating:
                    case global::PeerState.PeerCreated:
                        return false;
                }
            }
            return true;
    ...
    public static PeerState connectionStateDetailed
    {
        get
        {
            if (offlineMode)
            {
                return ((offlineModeRoom == null) ? global::PeerState.ConnectedToMaster : global::PeerState.Joined);
            }
            if (networkingPeer == null)
            {
                return global::PeerState.Disconnected;
            }
    ...
    public static bool inRoom
    {
        get
        {
            return (connectionStateDetailed == global::PeerState.Joined);
        }
    }
